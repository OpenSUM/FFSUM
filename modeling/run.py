...
from model import BertFF
from utils import compute_metrics, convert_examples_to_features, FFCCProcessor
...
MODEL_CLASSES = {
    'bertf': (BertConfig, BertFF, BertTokenizer),
...
def train(args, train_dataset, model, tokenizer):
    ...
    for epoch_ix in train_iterator:
        ...
        for step, batch in enumerate(train_dataloader):#(epoch_iterator):
            model.train()
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    preds = None
    out_label_ids = None
    f_logits = open(os.path.join(args.data_dir, "logits.out"), "w")
